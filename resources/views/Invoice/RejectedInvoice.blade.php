...
<html lang="en">
	<head>
		<base href="">
		<title>{{ config('app.name') }} | Rejected</title>
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
						...
						<div class="toolbar" id="kt_toolbar">
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Returned Invoices</h1>
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-toolbar">
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												...
												<!-- <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#kt_modal_create_account">Add Bill</button> -->
											</div>
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
											<thead>
												<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
													...
													<th class="min-w-125px">Bill Type</th>
													<th class="min-w-125px">Bill Month</th>
													<th class="min-w-125px">Bill Zone</th>
													<!-- <th class="min-w-125px">Neighborhood</th> -->
													<th class="min-w-125px">Bill Status</th>
													<th class="min-w-125px">Bill Date</th>
											...
											<tbody class="fw-bold text-gray-600">
												...
												<tr>
													...
													<td>EMMANUEL ANOKYE</td>
													<td>SIGN BOARD</td>
													<td>JANUARY, 2023</td>
													<td>ZONE 2</td>
													<td><div class="badge badge-light-warning">UPDATE</div></td>
													<td>25 Jul 2022</td>
													<td class="text-end">
														<a href="#" class="btn btn-sm btn-light btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
														<span class="svg-icon svg-icon-5 m-0">
												...
												<tr>
													...
													<td>RAYMOND BAFFOUR</td>
													<td>FILLING BOARD</td>
													<td>MARCH, 2023</td>
													<td>ZONE 2</td>
													<td><div class="badge badge-light-info">CHECK</div></td>
													<td>25 Jul 2022</td>
													<td class="text-end">
														<a href="#" class="btn btn-sm btn-light btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
														<span class="svg-icon svg-icon-5 m-0">
		...
		<?php //include('modals/customer.php');?>
