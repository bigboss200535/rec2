...
class CreateNationalIdentityTable extends Migration
{
    public function up()
    {
        Schema::create('national_identity', function (Blueprint $table) {

		$table->string('NationalId',20);
		$table->string('IdType',100);
    ...
    {
        Schema::dropIfExists('national_identity');
    }
}